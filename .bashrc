...
_set_my_PS1() {
    #PS1='[\u@\h \W]\$ '
    PS1="\[\e[97m\]\u@\[\e[93m\]\W\[\e[m\]:/\[\e[34m\]>\[\e[m\]\[\e[37m\]\\$\[\e[m\]"
...
alias winsproxy='ssh -f -N -D 9090 -p 8081 berke@wins.ceng.metu.edu.tr'
alias cengssh='ssh -p 8085 e2099372@divan.ceng.metu.edu.tr'
alias winsssh='ssh -p 8081 berke@wins.ceng.metu.edu.tr'
################################################################################
